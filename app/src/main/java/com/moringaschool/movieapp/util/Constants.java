...
public class Constants {
    ...
    public static final String API_KEY = "968ea3a3abb0726619a539a26d5d962b";
    public static final String EXTRA_POPULAR_MOVIES = "extra_movie";
    public static final String MOVIE_KEY = "movie_overview_key";
